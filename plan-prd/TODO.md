...
### 2. 废弃 extract-icon API
**来源**: `plan-prd/01-project/DESIGN_IMPROVEMENTS.md`
**工期**: 1-2 天

- [ ] 迁移所有使用 `file:extract-icon` 的代码
- [ ] 改为使用 `tfile://` 协议
- [ ] 更新文件图标加载组件
- [ ] 测试性能提升 (目标: 50-100ms → <10ms)
- [ ] 移除旧 IPC 通道
...
### 3. 日历插件
**来源**: `plan-prd/01-project/CALENDAR-PRD.md`
**工期**: 8-11 天
