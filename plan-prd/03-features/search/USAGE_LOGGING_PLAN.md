...
> **迁移自**: `apps/core-app/src/main/modules/box-tool/search-engine/USAGE_LOGGING_PLAN.md`
...
- **实现**: `apps/core-app/src/main/modules/box-tool/search-engine/search-core.ts`
- **相关文档**: [TUFF_USAGE_TRACKING_PRD.md](./TUFF_USAGE_TRACKING_PRD.md)
