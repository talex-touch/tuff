...
> **迁移自**: `apps/core-app/src/main/modules/download/API.md`
...
See [PERFORMANCE_OPTIMIZATIONS.md](../../04-implementation/performance/PERFORMANCE_OPTIMIZATIONS.md) for details.
...
- [PERFORMANCE_OPTIMIZATIONS.md](../../04-implementation/performance/PERFORMANCE_OPTIMIZATIONS.md) - Performance details
- [UPDATE_SYSTEM.md](./UPDATE_SYSTEM.md) - Update system documentation

---

## 代码位置

- **实现**: `apps/core-app/src/main/modules/download/`
- **UI组件**: `apps/core-app/src/renderer/src/components/download/`
