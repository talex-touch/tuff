...
export type IntelligenceContextStreamEvent<T = unknown> =
  IntelligenceStreamEvent<T> & {
    context?: IntelligenceContextExecutionSummary;
  };
...
> = {
  ...
  "text.grammar": {
    ...
    promptTemplate:
      "检查以下文本的拼写、语法、标点和表达问题，返回修正文本与问题列表。",
    providers: [
  ...
  "image.analyze": {
    ...
    promptTemplate:
      "详细分析图片，包括：物体识别、场景理解、颜色分析、构图评估。返回结构化结果。",
    providers: [
      {
        providerId: "siliconflow-default",
        models: ["THUDM/GLM-4.1V-9B-Thinking"],
