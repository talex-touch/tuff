...
<template>
  <div style="display: grid; gap: 10px; min-height: 120px; max-width: 100%;">
    <div style="display: flex; gap: 8px; flex-wrap: wrap; align-items: center;">
      <TxButton size="small" @click="expanded = !expanded">Toggle details</TxButton>
      <TxButton size="small" :disabled="count <= 0" @click="count--">- Item</TxButton>
      <TxButton size="small" @click="count++">+ Item</TxButton>
    </div>
    ...
    >
      <TxTabItem name="Overview" activation icon-class="i-carbon-dashboard">
        <TxCard variant="solid" background="glass" shadow="soft" :radius="18" :padding="12">
          <div style="display: flex; flex-direction: column; gap: 10px;">
            <div style="font-weight: 650;">Overview</div>
        ...
        <TxCard variant="solid" background="glass" shadow="soft" :radius="18" :padding="12">
          <div style="display: flex; flex-direction: column; gap: 10px;">
            <div style="display: flex; justify-content: space-between; align-items: center; gap: 10px;">
              <div style="font-weight: 650;">Details</div>
              <div style="font-size: 12px; color: var(--tx-text-color-secondary, #909399);">Items: {{ items.length }}</div>
            </div>
            ...
            <div style="display: grid; grid-template-columns: repeat(2, minmax(0, 1fr)); gap: 8px;">
              ...
              >
                <div style="font-weight: 600;">{{ it }}</div>
            ...
            <div v-if="expanded" style="display: flex; flex-direction: column; gap: 6px;">
              <div style="font-weight: 600;">Expanded block</div>
              <div style="font-size: 12px; color: var(--tx-text-color-secondary, #909399);">
      ...
      <TxTabItem name="Form" icon-class="i-carbon-settings">
        <TxCard variant="solid" background="glass" shadow="soft" :radius="18" :padding="12">
          <div style="display: flex; flex-direction: column; gap: 10px;">
            <div style="font-weight: 650;">Form</div>
