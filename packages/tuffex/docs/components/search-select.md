...
import SearchSelectRemoteDemo from '../.vitepress/theme/components/demos/SearchSelectRemoteDemo.vue'
import SearchSelectRemoteDemoSource from '../.vitepress/theme/components/demos/SearchSelectRemoteDemo.vue?raw'
</script>

## 基础用法

<DemoBlock title="SearchSelect" :code="SearchSelectBasicDemoSource">
  <template #preview>
    <SearchSelectBasicDemo />
  </template>
</DemoBlock>
...
<DemoBlock title="SearchSelect (remote)" :code="SearchSelectRemoteDemoSource">
  <template #preview>
    <SearchSelectRemoteDemo />
  </template>
</DemoBlock>
