...
import TabBarBasicDemo from '../.vitepress/theme/components/demos/TabBarBasicDemo.vue'
import TabBarBasicDemoSource from '../.vitepress/theme/components/demos/TabBarBasicDemo.vue?raw'
</script>
