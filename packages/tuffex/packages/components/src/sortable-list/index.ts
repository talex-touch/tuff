import type { SortableListDragMode, SortableListEmits, SortableListItem, SortableListProps } from './src/types'
...
export type { SortableListDragMode, SortableListEmits, SortableListItem, SortableListProps }
