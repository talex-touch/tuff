import type { TxFlatRadioContext, TxFlatRadioItemProps, TxFlatRadioProps, TxFlatRadioSize, TxFlatRadioValue } from './src/types'
...
export type { TxFlatRadioContext, TxFlatRadioItemProps, TxFlatRadioProps, TxFlatRadioSize, TxFlatRadioValue }
