import type { BaseAnchorAnimationOptions, BaseAnchorAnimationType, BaseAnchorProps } from './src/types'
...
export type { BaseAnchorAnimationOptions, BaseAnchorAnimationType, BaseAnchorProps }
