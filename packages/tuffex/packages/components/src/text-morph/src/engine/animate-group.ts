// Ported from torph/src/lib/text-morph/utils/replace-animate.ts
...
import { animateElement, cancelAnimations, getAnimationsOf } from './metrics'
...
export function animateGroupExit(
  ...
  elements.forEach((element, i) => {
    getAnimationsOf(element).forEach(animation => animation.cancel())
 ...
 */
export function replacedRuns(all: HTMLElement[], members: Set<HTMLElement>): HTMLElement[][] {
