import type {
  ...
  ChatMessageModel,
} from "@talex-touch/tuffex/chat";

export type TxAiMotionPreset =
  | "none"
  | "fade"
  | "slide-fade"
  | "rebound"
  | "blur";
export type TxAiTone =
  | "neutral"
  | "primary"
  | "success"
  | "warning"
...
export function toTuffexChatMessage(
  message: TxAiMessageModel,
): ChatMessageModel {
  return {
    id: message.id,
