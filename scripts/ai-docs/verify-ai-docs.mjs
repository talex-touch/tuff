...
const checks = [
  {
    ...
    needles: ['Stable 能力只承诺文本 + OCR', 'CoreBox AI Ask', 'Nexus AI invoke'],
  },
  {
    file: 'docs/plan-prd/03-features/ai-2.5.3-local-knowledge-retrieval-prd.md',
    needles: ['SQLite / FTS5 / metadata', 'Context Builder', '不把 embeddings 或向量数据库作为第一优先级'],
  },
  {
    file: 'docs/plan-prd/03-features/ai-2.5.4-context-hygiene-memory-prd.md',
    needles: ['Session / Checkpoint / Memory / Compression / ContextPackage', '默认轻上下文', '旧 session 原文不默认注入 prompt'],
  },
  {
  ...
  },
  {
    ...
    needles: ['P1-AI-250', 'P1-AI-253', 'P1-AI-254', 'P1-AI-255', 'P1-AI-258'],
  },
  {
