...
Rollback is `TUFF_DB_SEARCH_SPLIT_ENABLED=0`, the shared-file topology. Do not delete primary tables until all migrations and app-run evidence pass; the `=0` path is the way back and must stay intact.
