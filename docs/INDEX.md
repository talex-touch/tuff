...
| 文档 | 当前状态 | 下一动作 |
| --- | --- | --- |
| `docs/plan-prd/TODO.md` | 已同步到 2026-04-20 | 推进 `CoreApp legacy 清理 + Windows/macOS 2.5.0 阻塞级适配` |
...
| `docs/plan-prd/01-project/CHANGES.md` | 已同步到 2026-04-20 | 持续记录 CoreApp `2.5.0` 前置治理口径与证据 |
