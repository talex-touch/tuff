...
- [ ] 2.5.0 AI/workflow 后续：OmniPanel Writing Tools MVP、Desktop Context Capsule 最小版、翻译插件 Intelligence-first 与 TTS Beta typed 朗读入口、进程内短期缓存已落地；继续拆 Workflow `Use Model` 节点、完整 Review Queue、3 个 P0 模板，以及 TTS 队列/播放服务与持久缓存评估。
