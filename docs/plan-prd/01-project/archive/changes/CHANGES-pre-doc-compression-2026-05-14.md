...
- `apps/core-app/src/renderer/src/modules/openers/index.ts`
- `docs/plan-prd/TODO.md`
...
### refactor(transport): migrate corebox ui state retained aliases
...
- `apps/core-app/src/renderer/src/views/box/CoreBox.vue`
- `docs/plan-prd/TODO.md`
  - CoreBox UI state/input visibility 小组新增 canonical `core-box:ui:get-ui-view-state`、`core-box:ui:shortcut-triggered`、`core-box:ui:mode-exited`、`core-box:ui:hide-input` 与 `core-box:ui:show-input` typed events。
  - 保留 legacy aliases 承载旧 `core-box:get-ui-view-state`、`core-box:shortcut-triggered`、`core-box:ui-mode-exited`、`core-box:hide-input` 与 `core-box:show-input` wire names。
  - Main key transport 与 input visibility IPC 对 canonical/legacy 双监听；shortcut trigger 与 UI mode exit push 在兼容窗口内双发；renderer 保留 legacy push 双监听。
