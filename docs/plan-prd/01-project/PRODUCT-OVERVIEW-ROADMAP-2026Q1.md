...
- 2026-05-13 beta CI readiness 复核：`2.4.10-beta.22` 准备用于避开已存在的 `v2.4.10-beta.21` tag；Widget/CLI 最新修复与兼容性复核记录已合入，OmniPanel Gate、Utils Package CI 与 macOS beta build 准备结果延续有效；完整 `quality:pr` 仍被 `retired-ai-app` 既有 lint 债务阻断，不得宣称全仓 PR gate 已绿。
