# Tuff v2.4.14-beta.4 Release Notes
...
- The official Everything SDK archive pin has been independently reverified and refreshed, restoring the Windows production release gate while retaining strict hashing for the upstream unversioned asset.
