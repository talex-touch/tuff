# Tuff v2.4.14-beta.6 Release Notes
...
- The official Everything SDK was reverified, and macOS dual-architecture dependencies, dual-architecture signing evidence, and the privacy database startup race were fixed to restore cross-platform production release gates.
