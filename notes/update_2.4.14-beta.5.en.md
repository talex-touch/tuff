# Tuff v2.4.14-beta.5 Release Notes
...
- The official Everything SDK archive was reverified, and macOS dual-architecture optional dependencies plus the privacy database startup race were fixed to restore cross-platform production release gates.
