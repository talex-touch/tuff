...
import { IntelligenceCapabilityType, IntelligenceProviderType } from '@talex-touch/tuff-intelligence'
...
function createManager(): IntelligenceProviderManager {
  ...
  manager.registerFactory(IntelligenceProviderType.LOCAL, (config) => new SmokeLocalProvider(config))
  return manager
}
