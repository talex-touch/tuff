...
export const layoutAtomPresets: Record<LayoutPresetKey, LayoutAtomConfig> = {
  ...
  flat: {
    preset: 'flat',
    header: { border: 'none', height: 28, blur: false },
    aside: { position: 'left', width: 64, border: 'none', collapsed: false },
    view: { radius: [8, 0, 0, 0], shadow: 'none', padding: 6, background: 'transparent' },
    nav: { style: 'icon', activeIndicator: 'bar' }
  },
  compact: {
    preset: 'compact',
    header: { border: 'solid', height: 24, blur: false },
    aside: { position: 'left', width: 36, border: 'solid', collapsed: false },
  ...
  minimal: {
    preset: 'minimal',
    header: { border: 'none', height: 28, blur: false },
    aside: { position: 'hidden', width: 0, border: 'none', collapsed: true },
    view: { radius: [0, 0, 0, 0], shadow: 'none', padding: 0, background: 'transparent' },
    nav: { style: 'icon', activeIndicator: 'background' }
  },
  classic: {
    preset: 'classic',
    header: { border: 'solid', height: 40, blur: false },
    aside: { position: 'hidden', width: 0, border: 'none', collapsed: true },
    view: { radius: [0, 0, 0, 0], shadow: 'none', padding: 0, background: 'transparent' },
  ...
  card: {
    preset: 'card',
    header: { border: 'none', height: 32, blur: false },
    aside: { position: 'left', width: 72, border: 'none', collapsed: false },
    view: { radius: [12, 12, 12, 12], shadow: 'md', padding: 12, background: 'solid' },
    nav: { style: 'icon-text', activeIndicator: 'background' }
  },
  dock: {
    preset: 'dock',
    header: { border: 'none', height: 26, blur: false },
    aside: { position: 'bottom', width: 56, border: 'none', collapsed: false },
