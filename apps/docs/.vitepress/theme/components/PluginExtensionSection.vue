  ...
  <div class="plugin-extension-section">
    <div class="section-content">
      ...
      <p class="section-subtitle">
        Lightweight plugins and heavyweight extensions for ultimate customization
      </p>
      ...
      <div class="features-grid">
        ...
        <div class="feature-card">
          ...
          <p class="card-description">
            Comprehensive extensions that transform the core functionality of the application. Build entire new workflows and capabilities.
          </p>
        </div>
        <div class="feature-card">
          <div class="card-icon">
          ...
          <p class="card-description">
            All plugins and extensions integrate smoothly with the core application, maintaining performance and consistency.
          </p>
        </div>
        <div class="feature-card">
          <div class="card-icon">
          ...
          <p class="card-description">
            Comprehensive SDK and documentation make it easy for developers to create their own plugins and extensions.
          </p>
        </div>
      </div>
