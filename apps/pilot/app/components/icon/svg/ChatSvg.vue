...
<template>
  <svg xmlns="http://www.w3.org/2000/svg" width="1em" height="1em" viewBox="0 0 24 24">
    <g
      fill="currentColor" fillOpacity="0" stroke="currentColor" stroke-linecap="round" stroke-linejoin="round"
      stroke-width="2"
    >
      <path
      ...
      >
        <animate fill="freeze" attributeName="stroke-dashoffset" dur="0.6s" values="68;0" />
      ...
      <path stroke-dasharray="6" stroke-dashoffset="6" d="M8 13h4" opacity="0">
        ...
        <animate fill="freeze" attributeName="stroke-dashoffset" begin="1s" dur="0.2s" values="6;0" />
      </path>
    </g>
  </svg>
</template>
