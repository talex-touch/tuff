...
vi.mock('../../../../server/utils/creditsStore', () => creditMocks)
...
beforeAll(async () => {
  ...
  invokeAuditsHandler = (await import('../../../../server/api/dashboard/intelligence/invoke-audits.get')).default as (event: any) => Promise<any>
})
