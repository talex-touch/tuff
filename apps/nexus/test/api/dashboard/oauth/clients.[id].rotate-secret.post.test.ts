...
vi.mock('../../../../server/utils/oauthAccess', () => oauthAccessMocks)
vi.mock('../../../../server/utils/oauthClientStore', () => oauthClientStoreMocks)

let handler: (event: any) => Promise<any>

beforeAll(async () => {
  ;(globalThis as any).defineEventHandler = (fn: any) => fn
  handler = (await import('../../../../server/api/dashboard/oauth/clients/[id]/rotate-secret.post')).default as (event: any) => Promise<any>
})
