...
beforeAll(async () => {
  ...
  createRunHandler = (await import('../../../../server/api/admin/release-evidence/runs.post')).default as (event: any) => Promise<any>
  listRunsHandler = (await import('../../../../server/api/admin/release-evidence/runs.get')).default as (event: any) => Promise<any>
  getRunHandler = (await import('../../../../server/api/admin/release-evidence/runs/[runId].get')).default as (event: any) => Promise<any>
  upsertItemHandler = (await import('../../../../server/api/admin/release-evidence/runs/[runId]/items.post')).default as (event: any) => Promise<any>
  matrixHandler = (await import('../../../../server/api/admin/release-evidence/matrix.get')).default as (event: any) => Promise<any>
  docGuardHandler = (await import('../../../../server/api/admin/release-evidence/doc-guard.post')).default as (event: any) => Promise<any>
})
