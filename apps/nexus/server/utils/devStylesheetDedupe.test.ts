...
describe('dedupeDevTuffexStylesheets', () => {
  ...
  it('removes route-local marketing, store, and dashboard styles from docs dev html', () => {
    const html = [
      ...
      '<link rel="stylesheet" href="/_nuxt/components/VersionDrawer.vue?vue&type=style&index=0&lang.css">',
      '<link rel="stylesheet" href="/_nuxt/components/assets/create/AssetCreateOverlay.vue?vue&type=style&index=0&lang.css">',
      '<link rel="stylesheet" href="/_nuxt/pages/store.vue?vue&type=style&index=0&lang.scss">',
      '<link rel="stylesheet" href="/_nuxt/pages/new/components/NewNexusHero.vue?vue&type=style&index=0&lang.css">',
