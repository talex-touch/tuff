---
title: "Container 容器"
description: "容器组件是页面布局的基础，提供了灵活的布局选项和响应式设计支持。TouchX UI 的容器组件帮助您快速构建结构化的页面布局。"
---
# Container 容器
...
import ContainerBasicDemo from '~/components/content/demos/ContainerBasicDemo.vue'
import ContainerBasicDemoSource from '~/components/content/demos/ContainerBasicDemo.vue?raw'
</script>
