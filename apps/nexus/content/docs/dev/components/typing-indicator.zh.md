...
import TypingIndicatorVariantsDemo from '~/components/content/demos/TypingIndicatorVariantsDemo.vue'
import TypingIndicatorVariantsDemoSource from '~/components/content/demos/TypingIndicatorVariantsDemo.vue?raw'
</script>
