---
title: "Cascader 级联选择"
description: "用于选择具有层级关系的数据，支持搜索、单选/多选与异步加载子节点。"
---
# Cascader 级联选择
...
import CascaderBasicDemo from '~/components/content/demos/CascaderBasicDemo.vue'
import CascaderBasicDemoSource from '~/components/content/demos/CascaderBasicDemo.vue?raw'
</script>
