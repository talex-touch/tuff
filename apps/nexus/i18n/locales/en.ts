...
Tuff may update this agreement at any time. Continued submission indicates acceptance of changes.`,
      ...
      team: {
        ...
        notInvitedTitle: 'You are not on the invite list',
        notInvitedDesc: 'Teams are invite-only for now. Leave your email to join the waitlist and we’ll notify you when access opens.',
        waitlistHint: 'Already have an invite code? Join a team',
