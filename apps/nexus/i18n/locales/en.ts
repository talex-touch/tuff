  ...
  dashboard: {
    ...
    providerRegistry: {
      ...
      providers: {
        ...
        createHint: 'Credentials stay in secure storage; this form only saves authRef.',
    ...
    adminCredits: {
      ...
      subtitle: 'Track usage and ledger across all users.',
      actions: {
        filter: 'Filter',
      },
      usage: {
        title: 'User Usage',
        subtitle: 'Monthly usage with search by user ID or email.',
        totalUsed: 'Total used this month',
        totalQuota: 'Total quota this month',
        searchPlaceholder: 'Search user ID / email',
        empty: 'No records',
      },
      ledger: {
        title: 'Credit Ledger',
        subtitle: 'Every credit consumption entry.',
        searchPlaceholder: 'Filter by user ID / email',
        empty: 'No ledger entries',
      },
      errors: {
        loadUsage: 'Failed to load usage.',
    ...
    credits: {
      ...
      stats: {
        ...
        personalTotal: 'Personal quota {n}',
        teamRemaining: 'Team remaining',
        teamTotal: 'Team pool {n}',
        used: 'Used this month',
        usedHint: 'Personal quota {n}',
        personalShare: 'Personal share',
        shareHint: 'Personal {personal} · Total {total}',
      },
      tabs: {
        overview: 'Overview',
        signin: 'Check-in',
      ...
      trend: {
        title: 'Usage trend',
        subtitle: 'Last 14 days total usage',
        empty: 'No trend data',
      },
      share: {
        title: 'Personal share',
        subtitle: 'Personal {personal} / Total {total}',
        personal: 'Personal quota {n}',
        team: 'Team pool {n}',
      },
      apis: {
        title: 'Open access',
      ...
      boost: {
        ...
        subtitle: 'Verify email and bind OAuth + Passkey to raise personal quota to {n}.',
    ...
    team: {
      credits: {
        ...
        subtitle: 'Monthly usage and quota for team members.',
        totalUsed: 'Total used this month',
        totalQuota: 'Total quota this month',
        searchPlaceholder: 'Search user ID / email',
    ...
    intelligenceLab: {
      ...
      reset: 'Reset',
      empty: 'Send one message and TuffIntelligence will plan and execute automatically.',
...
Tuff may update this agreement at any time. Continued submission indicates acceptance of changes.`,
      ...
      intelligence: {
        ...
        subtitle: 'Manage AI providers, audits, and credit visibility.',
        tabs: {
          overview: 'Overview',
        ...
        providers: {
          title: 'Providers',
          modelsTitle: 'Service Channel Mirrors',
          modelsSubtitle: 'AI provider configuration is centralized in Service Channels. This page only shows migration state, scene bindings, and probes.',
          addButton: 'Add Provider',
          openRegistry: 'Open Service Channels',
          configureInRegistry: 'Configure in Service Channels',
          empty: 'No AI providers configured yet. Create providers and capabilities in Service Channels.',
          ...
          migration: {
            ...
            migrated: 'Migrated',
            failed: 'Failed',
            readiness: 'Registry read readiness',
            ready: 'Ready',
            blocked: 'Blocked',
            planning: 'Planning',
            registryPrimaryReady: 'Registry-primary ready',
            blockers: 'Blockers',
            ...
            blocker: {
              migration_dry_run_only: 'Dry-run only; migration has not been executed',
              migration_failed: 'Migration has failed items',
              migration_not_executed: 'Migration has not been executed',
              registry_mirror_missing: 'Registry mirror is incomplete',
            },
          },
          probe: {
            ...
            connecting: 'Connecting model stream…',
            streaming: 'Model is streaming…',
            fallback: 'Streaming probe is unavailable. Falling back to regular probe…',
            stop: 'Stop',
          },
          delete: 'Delete',
