...
export default {
  ...
  pricing: {
    ...
    freeTitle: 'Free',
    freePrice: '¥0 / month',
    freeDesc: 'Core features and community support',
    freeFeature1: 'Core plugin marketplace',
    freeFeature2: 'Personal device sync',
    freeFeature3: 'Limited AI credits',
    plusTitle: 'Plus',
    plusPrice: 'Coming soon',
    plusDesc: 'Enhanced experience for individuals',
    plusFeature1: 'Higher AI credit allowance',
    plusFeature2: 'Premium automation templates',
    plusFeature3: 'Priority support',
    teamTitle: 'Team',
    teamPrice: 'Coming soon',
    teamDesc: 'Team collaboration and shared quotas',
    teamFeature1: 'Shared team credit pool',
    teamFeature2: 'Member management',
    teamFeature3: 'Enterprise security',
    cta: 'Get started',
