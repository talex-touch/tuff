...
export type StoragePolicyEvaluationStatus =
  | "ok"
  | "warning"
  | "blocked"
  | "disabled";
export type StorageChannelPressureStatus =
...
export type ProviderQuotaRiskReason =
  | "blocked"
  | "warning-threshold"
  | "overage"
  | "low-remaining"
  | "projected-exhaustion";
export type ProviderQuotaActionQueuePriority =
  | "critical"
  | "high"
  | "medium"
  | "low";
...
export type ProviderQuotaSmokeStatus =
  | "allowed"
  | "blocked"
  | "consumed"
  | "failed";
export type StorageAlertMetric = "storedBytes" | "trafficBytes" | "operations";
export type StorageAlertLimitKey =
  | "maxBytes"
  | "trafficBytes"
  | "maxOperations"
  | "alertBytes";
export type PlatformGovernanceD1ReadinessStatus =
  | "ready"
  | "warning"
  | "blocked";
export type PlatformGovernanceReportStatus = "ok" | "watch" | "critical";
export type PlatformGovernanceReportPriority =
  | "critical"
  | "high"
  | "medium"
  | "low";
...
export type NotificationChannelReadinessStatus =
  | "ready"
  | "warning"
  | "disabled";
export type NotificationChannelDisplayStatus =
  | NotificationChannelRiskStatus
  | NotificationChannelReadinessStatus;
export type NotificationDeliveryStatus =
  | "planned"
  | "sent"
  | "skipped"
  | "failed";
export type NotificationActionQueuePriority =
  | "critical"
  | "high"
  | "medium"
  | "low";
export type NotificationActionQueueSource =
  | "channel-config"
  | "delivery-health";
...
export interface GovernanceAnalytics {
  ...
  dashboard: {
    ...
    trends: {
      ...
      >;
      providerUsage: Array<
        GovernanceTrendPoint & { requests: number; tokens: number }
      >;
      uploadStatus: Array<
        GovernanceTrendPoint & {
          started: number;
...
export type StorageChannelPolicySummary = Omit<
  GovernanceConfig,
  "config" | "createdBy" | "ownerId"
>;
...
export type NotificationCredentialType =
  | "api_key"
  | "smtp"
  | "webhook"
  | "bot_token";
