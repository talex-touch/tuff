    ...
    downloads: [
      {
        ...
        href: 'https://github.com/talex-touch/tuff/releases/tag/v2.0.0-preview',
      },
    ],
  },
  {
    ...
    downloads: [
      {
        ...
        labelKey: 'updates.downloads.previewPortal',
        descriptionKey: 'updates.downloads.previewPortalDescription',
        href: 'https://github.com/talex-touch/tuff/releases/tag/v2.0.0-dev.5',
      },
    ],
  },
  {
    ...
    downloads: [
      {
        ...
        href: 'https://github.com/talex-touch/tuff/releases/tag/v1.2.0',
      },
    ],
  },
  {
    ...
    downloads: [
      {
        ...
        labelKey: 'updates.downloads.releasePortal',
        descriptionKey: 'updates.downloads.releasePortalDescription',
        href: 'https://github.com/talex-touch/tuff/releases/tag/v1.1.0',
      },
    ],
  },
  {
    ...
    downloads: [
      {
        ...
        labelKey: 'updates.downloads.releasePortal',
        descriptionKey: 'updates.downloads.releasePortalDescription',
        href: 'https://github.com/talex-touch/tuff/releases/tag/v1.0.0',
      },
    ],
  },
]
