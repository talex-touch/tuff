...
export const tuffSdkItems: TuffSdkItem[] = [
  ...
  {
    id: "screenshot-sdk",
    title: "Screenshot SDK",
    description: "Permission-gated display, cursor & region capture.",
    tag: "context.utils.screenshot",
    color: "#0ea5e9",
  ...
  {
    id: "localization-sdk",
    title: "Localization SDK",
    description: "Host locale & scoped Domain Lexicon.",
    tag: "usePluginI18n()",
    color: "#c084fc",
