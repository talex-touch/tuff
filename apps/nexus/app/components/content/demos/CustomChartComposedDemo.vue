...
const rows: Row[] = [
  { month: 'Mar', revenue: 320, growth: 12 },
  { month: 'Apr', revenue: 410, growth: 28 },
  { month: 'May', revenue: 380, growth: -7 },
  { month: 'Jun', revenue: 520, growth: 37 },
  { month: 'Jul', revenue: 610, growth: 17 },
  { month: 'Aug', revenue: 690, growth: 13 },
]
</script>
