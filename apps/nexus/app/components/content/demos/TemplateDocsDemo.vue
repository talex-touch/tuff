  ...
  'welcome': {
    ...
    body: {
      zh: md(
        ...
        '## Tuff 是什么',
        '',
        'CoreBox 是 Tuff 的主界面，默认快捷键是 `⌘ E`（Windows 上是 `Ctrl E`）。你输入的内容会同时交给应用、文件、剪贴板历史和已安装的插件，结果按相关度排在一起。',
        '',
        '## 从哪里开始',
        '',
      ...
      en: md(
        ...
        '## What Tuff is',
        '',
        'CoreBox is Tuff’s main window. The default shortcut is `⌘ E` (`Ctrl E` on Windows). What you type goes to apps, files, clipboard history and your installed plugins at once, and the results are ranked together.',
        '',
        '## Where to start',
        '',
  ...
  'corebox': {
    ...
    body: {
      zh: md(
        '## 打开与搜索',
        '',
        '按 `⌘ E` 呼出 CoreBox，直接输入即可搜索。`↑` `↓` 选择结果，`↵` 执行，`Esc` 关闭窗口。',
        '',
        '## 插件结果',
        '',
      ...
      en: md(
        ...
        '',
        'Press `⌘ E` to bring up CoreBox and start typing. `↑` `↓` pick a result, `↵` runs it and `Esc` closes the window.',
        '',
        '## Plugin results',
        '',
  ...
  'shortcuts': {
    ...
    body: {
      zh: md(
        ...
        '| 操作 | macOS | Windows |',
        '| --- | --- | --- |',
        '| 呼出 CoreBox | <kbd>⌘</kbd> <kbd>E</kbd> | <kbd>Ctrl</kbd> <kbd>E</kbd> |',
        '',
        '## CoreBox 里',
        '',
        '| 操作 | 按键 |',
      ...
      en: md(
        ...
        '| --- | --- | --- |',
        '| Open CoreBox | <kbd>⌘</kbd> <kbd>E</kbd> | <kbd>Ctrl</kbd> <kbd>E</kbd> |',
        '',
        '## Inside CoreBox',
        '',
        '| Action | Keys |',
  ...
  'corebox-open': {
    ...
    body: {
      zh: md(
        '## 检查快捷键',
        '',
        '如果 `⌘ E` 被别的应用占用，CoreBox 就不会弹出。换一个快捷键，或先退出冲突的应用。',
        '',
        '## 重新启动',
        '',
      ...
      en: md(
        '## Check the shortcut',
        '',
        'If another app has taken `⌘ E`, CoreBox will not appear. Pick another shortcut, or quit the app that holds it.',
        '',
        '## Restart',
        '',
