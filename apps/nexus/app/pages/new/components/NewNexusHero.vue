...
const agentLogos: LogoItem[] = [
  { node: '<span class="i-logos-openai-icon"></span><span>Codex</span>', title: 'Codex' },
  { node: '<span class="i-logos-claude-icon"></span><span>Claude Code</span>', title: 'Claude Code' },
  ...
  { node: '<span class="i-logos-github-copilot"></span><span>Copilot</span>', title: 'GitHub Copilot' },
  { node: '<span class="NewAgentLogoMark">C</span><span>Cursor</span>', title: 'Cursor' },
  { node: '<span class="i-logos-qwen-icon"></span><span>Qwen Code</span>', title: 'Qwen Code' },
  { node: '<span class="NewAgentLogoMark">A</span><span>Auggie</span>', title: 'Auggie CLI' },
  { node: '<span class="i-logos-google-gemini"></span><span>Gemini CLI</span>', title: 'Gemini CLI' },
  { node: '<span class="i-logos-moonshot-ai-icon"></span><span>Kimi Code</span>', title: 'Kimi Code CLI' },
  { node: '<span class="i-logos-sourcegraph"></span><span>Amp</span>', title: 'Amp' },
  { node: '<span class="i-carbon-snowflake"></span><span>Cortex</span>', title: 'Cortex Code' },
  { node: '<span class="NewAgentLogoMark">CL</span><span>Cline</span>', title: 'Cline' },
  { node: '<span class="i-logos-mistral-ai-icon"></span><span>Mistral Vibe</span>', title: 'Mistral Vibe' },
  { node: '<span class="i-logos-deepseek-icon"></span><span>CodeWhale</span>', title: 'CodeWhale' },
